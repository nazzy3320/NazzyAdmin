...
--]]
 ...
 cmd.add({"plugins"}, {"plugins", "Check what kind of plugins you have, add plugins using a gui, delete a plugin."}, function()
	 loadstring(game:HttpGet("https://raw.githubusercontent.com/FilteringEnabled/FE/main/NazzyAdminPlugin"))();
 end)
 ...
 writefile("Nazzy-Admin\\Prefix.txt", PrefixChange)
 opt.prefix = PrefixChange
 Notify({
...
print(Time)
 ...
 Notify({
	 Description = "Nazzy Admin currently has ".. commandcount .. " commands";
	 Title = "Nazzy Admin";
	 Duration = 5;
...
if b:IsA("Folder") then
 ...
 cmd.add({"admin"}, {"admin", "whitelist someone to allow them to use commands"}, function(...)
	 ...
	 if Player ~= nil and not Admin[Player.UserId] then
		 ...
		 ChatMessage("/w "..Player.Name.." [Nazzy Admin] You've got admin. Prefix: ';'")
		 wait(0.2)
		 ChatMessage("/w "..Player.Name.." [Nazzy Admin Commands] glue, unglue, fling, fling2, spinfling, unspinfling, fcd, fti, fpp, fireremotes, holdhat")
...
-- [[ THANKS TO LIGHTING BOLT FOR THIS ]] --
 ...
 speed = (...)
	 ...
	 if table.find({Enum.Platform.IOS, Enum.Platform.Android}, game:GetService("UserInputService"):GetPlatform()) then 
		 ...
		 Notify({
		 Description = "Nazzy Admin has detected you using mobile you now have a mfly button click it to enable / disable mobile flying (For easier use)";
		 Title = "Nazzy Admin";
		 Duration = 5;
		 });
...
game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(A_1,A_2)
 ...
 cmd.add({"aimbotv2", "aimbotno", "aimbotv2"}, {"aimbotV2 (aimbotno, aimbotno)", "aimbot and yeah"}, function()
 loadstring(game:HttpGet('https://raw.githubusercontent.com/nazzy3320/Admin-panel-NZ/main/aimbot.lua'))()
 end)

cmd.add({"Pressure"}, {"Pressure", "Pressure"}, function()
	 loadstring(game:HttpGet("https://raw.githubusercontent.com/nazzy3320/Admin-panel-NZ/main/Pressure.lua"))()
 end)

cmd.add({"arsenal"}, {"arsenal", "arsenal"}, function()
	 loadstring(game:HttpGet("https://raw.githubusercontent.com/toasty-dev/pissblox/main/solaris_bootstrapper.lua",true))()
 end)

cmd.add({"scriptall"}, {"scriptall", "scriptall"}, function()
...
cmd.add({"Evade"}, {"Evade", "Evade"}, function()
 ...
 loadstring(game:HttpGet("https://raw.githubusercontent.com/FilteringEnabled/NazzyAdmin/main/AnimationSpoofer"))()
 end)
...
print(text)
 ...
 TextLabel_2.Text = "You are executing an anti-chat-log script meaning that Nazzy Admin wouldnt be able to detect when you have chatted meaning if you are on mobile and use the chat to execute commands it wont work. Are you sure you want to execute this?"
...
getChar().HumanoidRootPart.CFrame = target.Character.Humanoid.RootPart.CFrame
 ...
 loadstring(game:HttpGet("https://raw.githubusercontent.com/FilteringEnabled/NazzyAdmin/main/pp"))()
 end)
...
until glueloop == false
		 ...
		 v:Disconnect()
				 ...
				 cmd.add({"prompt", "purchaseprompts"}, {"prompt (purchaseprompts)", "allows the stupid purchase prompt"}, function()
					 ...
					 game.CoreGui.PurchasePrompt.Enabled = true
								 ...
								 cmd.add({"Nazzy"}, {"Nazzy", "Makes your hats visible but not your name or your body"}, function()
 loadstring(game:HttpGet("https://raw.githubusercontent.com/FilteringEnabled/FE/main/Nazzy"))()
 end)
 ...
 loadstring(game:HttpGet("https://raw.githubusercontent.com/FilteringEnabled/NazzyAdmin/main/Notepad"))()
 end)
...
_G.HeadSize = 10
 ...
 loadstring(game:HttpGet("https://raw.githubusercontent.com/FilteringEnabled/NazzyAdmin/main/GiveHat"))()
 end)
...
game.Players.LocalPlayer.CameraMode = "LockFirstPerson"
 ...
 if table.find({Enum.Platform.IOS, Enum.Platform.Android}, game:GetService("UserInputService"):GetPlatform()) then 
	 ...
	 Notify({
	 Description = "Nazzy Admin has detected you using mobile you now have a invisible button click it to enable / disable invisibility";
	 Title = "Nazzy Admin";
	 Duration = 7;
	 });
 ...
 cmd.add({"httpspy"}, {"httspy", "HTTP Spy"}, function()
	 loadstring(game:HttpGet('https://raw.githubusercontent.com/FilteringEnabled/NazzyAdmin/main/HttpSpy'))()
 end)
 ...
 local success, result = pcall(function()
			 for i,v in pairs(listfiles("Nazzy-Admin/Plugins")) do
			 loadstring(readfile(listfiles("Nazzy-Admin/Plugins")[i]))();
...
-- table.find({Enum.Platform.IOS, Enum.Platform.Android}, game:GetService("UserInputService"):GetPlatform()) | searches if the player is on mobile.
 ...
 TextClickButton.Name = "NazzyAdminButton"
 ...
 TextClickButton.Text = "Nazzy Admin " .. currentversion .. ""
